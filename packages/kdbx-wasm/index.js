...
export const JsMetadata = wasm.JsMetadata;
export const JsHeaderInfo = wasm.JsHeaderInfo;
export const JsKdfParams = wasm.JsKdfParams;
export const JsFileInfo = wasm.JsFileInfo;
